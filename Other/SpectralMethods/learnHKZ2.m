...
% [2] Mossel, Elchanan, and S�bastien Roch. 
...
EMIShat = real(transpose(EMIShat));

EmisInv = pinv(EMIShat);

% Calculate initial state distribution
PINIThat = EmisInv*P1hat;

% Calculate transition matrix
TRANShat = real(EmisInv * P21hat * transpose(EmisInv) * diag(PINIThat)^(-1));
